...
And that (2) “the total amount of within-patch time can be represented as:
...
\begin{itemize}
	...
	\item{\textbf{CueTests}: includes test related to the appropriate generation of cue values
	\begin {itemize}
			\item{\textbf{test\_appropriate\_cue}: checks that, given an array, a maximum of gold and a scan value,  \textit{tcuegen.py} produces the appropriate cues. }
